...
describe("nameInverter", function() {
  ...
  const inputName = "Elvis  ";
  const expectedOutput = "Elvis";
  assert.equal(nameInverter(inputName), expectedOutput);
  });

  it("should return a last-name, first-name when passed a first and last-name", function() {
  const inputName = "Elvis Bun";
  const expectedOutput = "Bun, Elvis";
  assert.equal(nameInverter(inputName), expectedOutput);
  });
  ...
  const inputName = "Dr. Elvis";
  const expectedOutput = "Dr. Elvis";
  assert.equal(nameInverter(inputName), expectedOutput);
  });

  it("should return a honorific last-name, first-name when passed honorific first-name last-name", function() {
  const inputName = "Dr. Elvis Bun";
  const expectedOutput = "Dr. Bun, Elvis";
  assert.equal(nameInverter(inputName), expectedOutput);
  });
